...
class AppointmentsController extends AppController
{
    ...
    public function add()
    {
        ...
        $customers = $this->Appointments->Customers->find('list', ['limit' => 200])->all();
        $developers = $this->Appointments->Developers->find('list', ['limit' => 200])->all();
        $this->set(compact('appointment', 'customers', 'developers'));
    }
