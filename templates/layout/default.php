...
<body>
    <nav class="top-nav">
        <div class="top-nav-title">
            <a href="<?= $this->Url->build('/') ?>"><span>Hackerek</span> KFT.</a>
        </div>
        <div class="top-nav-links">
            ...
            <?= $this->Html->link(__('Developers'), ['controller' => 'Developers', 'action' => 'index']) ?>
            ...
            <?= $this->Html->link(__('Logout'), ['controller' => 'Admins', 'action' => 'logout']) ?>
